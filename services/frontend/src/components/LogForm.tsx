...
import { LOG_TYPES, type LogType, type Schedule } from '../api/types'
...
export function LogForm({ entityId, schedules, onSubmit, isSubmitting, submitError }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      {selectedSchedule?.interval_type === 'usage' && (
